const ContactMe = () => {
    return (
        <div className="w-full bg-red-50 py-10 px-4 sm:px-6 border-t border-red-100">
            <div className="max-w-6xl mx-auto">
                {/* Header */}
                <div className="text-center mb-8">
                    <h2 className="text-2xl md:text-3xl font-semibold text-red-900 mb-2">Get In Touch</h2>
                    <div className="w-16 h-1.5 bg-red-500 mx-auto rounded-full mb-4"></div>
    ...
    return (
        <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition duration-200 text-center">
            ...
            <a
                ...
                className="text-red-600 hover:text-red-700 text-sm break-words"
            >
                {content}
            </a>
        </div>
