...
export const TopNavBar = () => {
  ...
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-2xl px-4">
      <div className="bg-grey-50/70 backdrop-blur-lg shadow-lg rounded-xl px-4 py-2 flex justify-between items-center">
        {/* Mobile menu button */}
        {isMobile && (
          <>
            <button
        ...
        {isMobile && showMobileMenu && (
          <div className="absolute top-15 left-0 w-full bg-grey-50/70 rounded-2xl transition-all duration-800 backdrop-blur-lg shadow-xl py-3 z-50 border border-gray-100">
            {navItems.map((item, index) => (
              <Link
                key={index}
                to={item.url}
        ...
        <div className="relative">
          <div className="relative">
            ...
            <div
              className={`absolute right-0 top-0 w-80 bg-white rounded-xl shadow-2xl overflow-hidden transition-all duration-700 z-50 
            ...
            >
              ...
              <div className="p-4 space-y-3">
                <div className="flex items-start text-gray-800">
                  <FaEnvelope className="text-teal-500 mt-1 mr-3" />
                  <div>
                ...
                <div className="flex items-start text-gray-800">
                  <FaPhone className="text-teal-500 mt-1 mr-3" />
                  <div>
                ...
                <div className="flex items-start text-gray-800">
                  <FaMapMarkerAlt className="text-teal-500 mt-1 mr-3" />
                  <div>
              ...
              <div className="flex justify-between items-center p-4 border-t border-gray-100">
                <a
                  href={user.resumeUrl}
                  download
                  className="flex items-center space-x-2 text-gray-700 hover:text-teal-600 text-sm font-medium transition-colors"
