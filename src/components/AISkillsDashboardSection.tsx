        ...
        <div className="py-8 px-4 sm:px-6 lg:px-8 bg-white">
            <div className="max-w-5xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
                    AI for <span className="text-rose-600">Productivity</span>
                </h2>
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                    <div>
                        <h3 className="text-rose-700 font-semibold mb-2">Content Generation</h3>
                        <p className="text-gray-600 text-sm">
                            Generate articles, documentation, and summaries using smart AI prompts and templates.
                        </p>
                    </div>
                    <div>
                        <h3 className="text-rose-700 font-semibold mb-2">Developer Productivity</h3>
                        <p className="text-gray-600 text-sm">
                            Leverage AI for code generation, refactoring, debugging, and rapid prototyping.
                        </p>
                    </div>
                    <div>
                        <h3 className="text-rose-700 font-semibold mb-2">Workflow Automation</h3>
                        <p className="text-gray-600 text-sm">
