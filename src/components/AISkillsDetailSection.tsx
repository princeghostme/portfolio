            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                        AI <span className="text-rose-600">Productivity</span> Expertise
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {aiSkills.map((skillGroup, index) => (
                        ...
                        >
                            <div className="px-6 py-4 border-rose-200">
                                <h3 className="text-xl font-semibold text-rose-800">
                                    {skillGroup.category}
                                </h3>
                                <div className={`w-16 h-1 bg-rose-500 rounded-full mt-2`}></div>
                            </div>
                            <div className="p-6">
                                <ul className="space-y-3">
                                    {skillGroup.skills.map((skill, skillIndex) => (
                                        ...
                                        >
                                            ...
                                            <span className="hover:text-rose-800">{skill}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                ...
                <div className="mt-16 bg-rose-50 rounded-xl p-8 border border-rose-100">
                    <h3 className="text-2xl font-semibold text-rose-800 mb-6">How AI Boosts Productivity</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-rose-700">
                        <div>
