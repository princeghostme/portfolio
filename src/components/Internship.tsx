                    ...
                    {experiences.map((exp, index) => (
                        <div key={index} className="relative group">
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-purple-50 overflow-hidden">
                                {/* Ribbon for type */}
                                <div className={`absolute top-0 right-0 px-4 py-1 text-xs font-bold text-white ${exp.type === "Internship" ? 'bg-purple-600' : 'bg-emerald-600'}`}>
                                    {exp.type}
                                </div>
                                ...
                                {/* Responsibilities */}
                                <div className="mb-4">
                                    <h5 className="text-sm font-semibold text-purple-700 uppercase tracking-wider mb-2">Key Contributions</h5>
                                ...
                                <div className="pt-3 border-t border-purple-100">
                                    <h5 className="text-sm font-semibold text-purple-700 uppercase tracking-wider mb-2">Skills Gained</h5>
