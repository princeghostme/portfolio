            ...
            <div className="mx-auto">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-rose-900 mb-4">
                        <span className="text-rose-600">Internships</span> & Training
                    </h1>
                ...
                <div className="space-y-8">
                    {experiences.map((exp, index) => (
                        <div key={index} className="relative group">
                            {/* Card */}
                            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-rose-50 overflow-hidden">
                                {/* Ribbon for type */}
                                <div className={`absolute top-0 right-0 px-4 py-1 text-xs font-bold text-white ${exp.type === "Internship" ? 'bg-rose-600' : 'bg-emerald-600'}`}>
                                    {exp.type}
                                </div>
                                ...
                                <div className="pr-10">
                                    ...
                                    <h4 className="text-lg font-semibold text-rose-700">{exp.company}</h4>
                                    <p className="text-sm text-rose-500 mb-3">{exp.duration}</p>
                                    <p className="text-gray-700 mb-4">{exp.description}</p>
                                </div>

                                {/* Responsibilities */}
                                <div className="mb-4">
                                    <h5 className="text-sm font-semibold text-rose-700 uppercase tracking-wider mb-2">Key Contributions</h5>
                                ...
                                <div className="pt-3 border-t border-rose-100">
                                    <h5 className="text-sm font-semibold text-rose-700 uppercase tracking-wider mb-2">Skills Gained</h5>
