        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center">
              ...
              <a href="mailto:yaduvanshiprince2007@gmail.com" className="text-purple-600 hover:underline">
            ...
            <div className="flex items-center">
              ...
              <a href="https://www.linkedin.com/in/prince-yadav-340b99134" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">
                LinkedIn Profile
              </a>
            </div>
            <div className="flex items-center">
