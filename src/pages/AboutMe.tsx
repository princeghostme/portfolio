        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center">
              ...
              <a href="mailto:yaduvanshiprince2007@gmail.com" className="text-rose-600 hover:underline">
                yaduvanshiprince2007@gmail.com
              </a>
            </div>
            <div className="flex items-center">
              <svg className="w-5 h-5 text-rose-500 mr-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
              </svg>
              <a href="https://www.linkedin.com/in/prince-yadav-340b99134" target="_blank" rel="noopener noreferrer" className="text-rose-600 hover:underline">
                LinkedIn Profile
              </a>
            </div>
            <div className="flex items-center">
